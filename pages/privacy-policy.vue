<template>
  <div class="pt-32 space-y-10 w-5/12 mx-auto">
    ...
    <div>
      <h2 class="text-2xl font-bold">SUMMARY OF KEY POINTS</h2>
      <div>
        <p>
          <i
    ...
    <div>
      <ol class="heading space-y-10">
        <li>
          <h2 id="WHAT-INFORMATION-DO-WE-COLLECT" class="text-2xl font-bold">
          ...
          <div class="my-4">
            ...
            <ul>
              ...
              <li>
                ...
                information either by fefusing access to the information or by
        ...
        <li>
          <h2
            id="WHAT-LEGAL-BASIS-DO-WE-RELY-ON-TO-PROCESS-YOUR-INFORMATION"
            class="text-2xl font-bold"
          >
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                regulatory agency, exercise or defend our legal fights, or
            ...
            <ul>
              ...
              <li>
                If itis reasonable to expect collection and use with consent
              ...
              <li>
                ...
                court order, or Tules of the court relating to the production of
                records
              </li>
              <li>
        ...
        <li>
          <h2 id="WHAT-ARE-YOUR-PRIVACY-RIGHTS" class="text-2xl font-bold">
          ...
          <div>
            ...
            <p>
              ...
              http./Awww.aboutads. info/choices/.
            </p>
            <p>
        ...
        <li>
          <h2
            id="DO-CALIFORNIA-RESISDENTS-HAVE-SPECIFIC-PRIVACY-RIGHTS"
            class="text-2xl font-bold"
          >
            DO CALIFORNIA RESISDENTS HAVE SPECIFIC PRIVACY RIGHTS?
          </h2>
          <p>
          ...
          <table>
            ...
            <tr>
              <td>A. Identifiers</td>
              <td>
                contact number, unique personal identifier, NO online
            ...
            <tr>
              ...
              <td>
                ...
                data, and interactions ith our and other websites, applications,
            ...
            <tr>
              <td>H. Audio, electronic, visual,</td>
            ...
            <tr>
              ...
              <td>
                Business contact details in order to provide you our servies at
                a business level or job title, work history or Professional
                qualifications if you apply a job with us
              </td>
              <td>NO</td>
            </tr>
            <tr>
          ...
          <p>
            ...
            such as for undertaking intemal research for technological
        ...
        <li>
          <h2 id="DO-WE-MAKE-UPDATES-TO-THIS-NOTICE" class="text-2xl font-bold">
