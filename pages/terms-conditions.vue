<template>
  <div class="pt-32 space-y-10 w-5/12 mx-auto">
    <div>
      ...
      <br />
      <h4>Last updated June 14, 2022</h4>
    </div>
    <div>
      ...
      <ol class="toc">
        ...
        <li><a href="#user-representation">3. USER REPRESENTATION</a></li>
        <li><a href="#prohibited-activities">4. PROHIBITED ACTIVITIES</a></li>
        <li>
          <a href="#user-generated-contributions">
            5. USER GENERATED CONTRIBUTIONS</a
          >
        </li>
        <li><a href="#contribution-license">6. CONTRIBUTION LICENSE</a></li>
        <li><a href="#submissions">7. SUBMISSIONS</a></li>
        <li><a href="#site-management">8. SITE MANAGEMENT</a></li>
        <li><a href="#term-and-termination">9. TERM AND TERMINATION</a></li>
        <li>
          <a href="#modifications-and-interruptions">
            10. MODIFICATIONS AND INTERRUPTIONS</a
          >
        </li>
        ...
        <li>
          <a href="#limitations-of-liability">15. LIMITATIONS OF LIABILITY</a>
        </li>
        <li><a href="#idemification">16. INDEMIFICATION</a></li>
        <li><a href="#user-data">17. USER DATA</a></li>
        <li>
          <a href="#electronic-communitions">
            18. ELECTRONIC COMMUNITIONS, TRANSACTIONS, AND SIGNATURES</a
          >
        </li>
    ...
    <ol class="heading">
      <li>
        <h2 id="agreement-to-terms" class="text-2xl font-bold">
          AGREEMENT TO TERMS
        </h2>
        <p>
          These Terms of Use constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (“you”) and
          Limelight Devs, concerning your access to and use of the website as
      ...
      <li>
        <h2 id="intellectual-property-rights" class="text-2xl font-bold">
      ...
      <li>
        <h2 id="user-representation" class="text-2xl font-bold">
          USER REPRESENTATION
        </h2>
        <p>
      ...
      <li>
        <h2 id="prohibited-activities" class="text-2xl font-bold">
        ...
        <ul>
          ...
          <li>
            Disparage, tamish, or otherwise harm, in our opinion, us and/or the
            Site.
          </li>
          <li>
          ...
          <li>
            Make any unauthorized use of the Site, including collecting usemames
      ...
      <li>
        <h2 id="user-generated-contributions" class="text-2xl font-bold">
        ...
        <ul>
          ...
          <li>
            Your Contributions do not violate any applicable law conceming child
      ...
      <li>
        <h2 id="contribution-license" class="text-2xl font-bold">
        ...
        <p>
          ...
          Contributions. We are not liable for any statements or fepresentations
      ...
      <li>
        <h2 id="submissions" class="text-2xl font-bold">SUBMISSIONS</h2>
        <p>
      ...
      <li>
        <h2 id="site-management" class="text-2xl font-bold">SITE MANAGEMENT</h2>
        <p>
      ...
      <li>
        <h2 id="term-and-termination" class="text-2xl font-bold">
        ...
        <p>
          ...
          prohibited from fegistering and creating a new account under your
      ...
      <li>
        <h2 id="modifications-and-interruptions" class="text-2xl font-bold">
      ...
      <li>
        <h2 id="governing-law" class="text-2xl font-bold">GOVERNING LAW</h2>
        <p>
          These Terms shall be governed by and defined following the laws of New
          York . Limelight Devs and yourself irrevocably consent that the courts
          of New York shall have exclusive jurisdiction to resolve any dispute
          which may arise in connection with these terms.
        </p>
      </li>

      <li>
        <h2 id="dispute-resolution" class="text-2xl font-bold">
          DISPUTE RESOLUTION
        </h2>
        ...
        <p>
          ...
          be 3. The seat, or legal place, of arbitration shall be New York. The
        ...
        <p>
          ...
          purported Tepresentative capacity on behalf of the general public or
          any other persons.
        </p>
      ...
      <li>
        <h2 id="corrections" class="text-2xl font-bold">CORRECTIONS</h2>
        <p>
      ...
      <li>
        <h2 id="disclaimer" class="text-2xl font-bold">DISCLAIMER</h2>
        <p>
          ...
          PRODUCT OR SERVICE ADVERTISED OR OFFERED BY ATHIRD PARTY THROUGH THE
          ...
          ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGEMENT AND EXERSISE CAUTION
          WHERE APPROPRIATE
        </p>
      </li>

      <li>
        <h2 id="limitations-of-liability" class="text-2xl font-bold">
      ...
      <li>
        <h2 id="idemification" class="text-2xl font-bold">INDEMIFICATION</h2>
        <p>
          ...
          Tepresentations and warranties set forth in these Terms of Use; (4)
      ...
      <li>
        <h2 id="user-data" class="text-2xl font-bold">USER DATA</h2>
        <p>
      ...
      <li>
        <h2 id="electronic-communitions" class="text-2xl font-bold">
          ELECTRONIC COMMUNITIONS, TRANSACTIONS, AND SIGNATURES
        </h2>
        <p>
          ...
          OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIATHE SITE. You
      ...
      <li>
        <h2 id="miscellaneous" class="text-2xl font-bold">MISCELLANEOUS</h2>
        <p>
          ...
          fullest extent permissible by law. We may assign any or alll of our
      ...
      <li>
        <h2 id="contact-us" class="text-2xl font-bold">CONTACT US</h2>
        <p>
          In order to resolve a complaint regarding the Site or to recieve
          further information or to receive further information about this Site,
          please contact us at.
        </p>
        Limelight Devs
        <p>81-06 78th Avenue, Glendale, NY, 11385</p>
        <p><b>Phone:</b>(347) 853-6977</p>
